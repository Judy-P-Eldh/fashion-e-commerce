export default function ContactPage() {
  return (
    <div className="content-x-small rounded-2xl bg-light p-8 shadow">
      ...
      <p>
        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Porro nemo qui
        omnis nam consequatur aperiam recusandae placeat. Quae nobis vitae,
        animi tempora adipisci optio sit doloribus dicta ex molestiae est.
      </p>
